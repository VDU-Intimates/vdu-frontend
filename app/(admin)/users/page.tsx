...
import AdminNavBar from "@/app/components/nav-bar/admin-nav-bar"; // ✅ Fixed import name and path
...
const UserManagement = () => {
  ...
  return (
    <div className="flex h-screen font-railway bg-[#F8F4EB]">
      {/* ✅ Fixed: Use AdminNavBar without props since it doesn't accept them */}
      <AdminNavBar />
