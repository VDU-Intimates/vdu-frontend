...
const PrimaryButton = ({context,icon: Icon,onClick,type = "button"}:primaryButtonProps) => {
  return (
    <div className='w-[240]  h-[60] max-md:w-[180] max-lg:w-[190] max-md:gap-1 max-md:h-[40]
        ...
        <button onClick={onClick} type={type} className='p-3 flex items-center justify-center
